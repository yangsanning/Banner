...
/**
 * @Author yangsanning
 * @ClassName SBannerViewPager
 * @Description 一句话概括作用
 * @Date 2019/1/18
 * @History 2019/1/18 author: description:
 */
public class SBannerViewPager extends ViewPager {

    private ArrayList<Integer> childCenterXAbs = new ArrayList<>();
    private SparseArray<Integer> childIndex = new SparseArray<>();

    public SBannerViewPager(Context context) {
        this(context, null);
    }

    public SBannerViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
